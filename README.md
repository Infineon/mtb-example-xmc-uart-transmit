...
In this code example, the UART is configured to send "Hello World" message to the terminal at an interval of 1 second. The user LED toggles at approximately 1 Hz.
...
**Note:** For the XMC1400 Boot Kit, pins P1_2 and P1_3 have been used for UART tx and rx, respectively; while for the XMC4700 Relax Kit, pins P1_5 and P1_4 have been used for UART tx and rx, respectively.
...
Document Title: *CE232576* - *XMC MCU: UART Transmit*
